...
import {googleAuthProxyRouter} from "./routes/googleAuthProxyRouter";
import {localAuthProxyRouter} from "./routes/localAuthProxyRouter";
import {facebookAuthProxyRouter} from "./routes/facebookAuthProxyRouter";
...
export class Server {
    ...
    public setRoutes = () => {
        ...
        this.app.use("/auth/facebook", facebookAuthProxyRouter);
    ...
    public setStaticFolders = () => {
        ...
        let clientPath = path.join(__dirname, '../../client/authclient/dist');
